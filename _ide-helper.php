 ...
 * Generated for Laravel 5.7.28 on 2019-04-16 09:38:00.
 *
...
namespace Illuminate\Support\Facades {
    ...
    class Auth
    {
        ...
        {
            return \Illuminate\Auth\SessionGuard::loginByEmail($email);
        }
    }
    ...
    class Redirect
    {
        ...
        /**
         * Create a new redirect response to the previous location, but only use the
         * previous URL stored in the session to determine the location.
         *
         * @param int $status
         * @param array $headers
         * @param mixed $fallback
         ...
         * @static
         */
        public static function return($status = 302, $headers = array(), $fallback = false)
        {
            return \Illuminate\Routing\Redirector::return($status, $headers, $fallback);
        }
    }
    ...
    class Request
    {
        ...
        {
            return \Illuminate\Http\Request::hasQuery();
        }
    }
    ...
    class URL
    {
        ...
        public static function full()
        {
            ...
            /** @var \App\Http\AppUrlGenerator $instance */
         ...
         *
         * @param \Closure $callback
         * @return \App\Http\AppUrlGenerator
         * @static
         */
        ...
        {
            //Method inherited from \Illuminate\Routing\UrlGenerator
            \App\Http\AppUrlGenerator::macro($name, $macro);
        }
        ...
        {
            //Method inherited from \Illuminate\Routing\UrlGenerator
            \App\Http\AppUrlGenerator::mixin($mixin);
        }
        ...
        {
            //Method inherited from \Illuminate\Routing\UrlGenerator
            return \App\Http\AppUrlGenerator::hasMacro($name);
        }
    }
...
namespace Spatie\Html\Facades {
    ...
    class Html
    {
        ...
        {
            return \Spatie\Html\Html::formError($field);
        }
         ...
         * @static
         */
        public static function vat($name = 'vat_percentage')
        {
            return \Spatie\Html\Html::vat($name);
        }
        ...
        {
            return \Spatie\Html\Html::editor($name, $value);
        }
    }
}
...
namespace Propaganistas\LaravelFakeId\Facades {
    ...
    class FakeId
    {
        ...
        {
            /** @var \Jenssegers\Optimus\Optimus $instance */
...
namespace {
    ...
    class Eloquent extends \Illuminate\Database\Eloquent\Model
    {
         ...
         * @static
         */
        public static function orderByNullLast($field)
        {
            return \Illuminate\Database\Query\Builder::orderByNullLast($field);
        }
         ...
         * @static
         */
        public static function orderByDescNullLast($field)
        {
            return \Illuminate\Database\Query\Builder::orderByDescNullLast($field);
        }
    }
    ...
    class FakeId extends \Propaganistas\LaravelFakeId\Facades\FakeId
    { }
